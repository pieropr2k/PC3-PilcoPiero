...
public class GameTest {
    ...
    void setUp(){
        ...
        this.game = new Game(wordSelector, hintGenerator, maximumAttempts);
    ...
    void definitiveBadInit() {
        this.game = new Game(null, null, maximumAttempts);
    ...
    void initOnlyWithWordSelector() {
        IWordSelector wordSelector = new WordSelector(possibleWordsList);
        this.game = new Game(wordSelector, null, maximumAttempts);
        assertThatExceptionOfType(IllegalArgumentException.class)
                .isThrownBy(()->{
                    game.start(selectedWordIndex);
                });
    ...
    void initOnlyWithHintGenerator() {
        IHintGenerator hintGenerator = new HintGenerator(possibleWordsList[selectedWordIndex]);
        this.game = new Game(null, hintGenerator, maximumAttempts);
        assertThatExceptionOfType(IllegalArgumentException.class)
                .isThrownBy(()->{
                    game.start(selectedWordIndex);
                });
